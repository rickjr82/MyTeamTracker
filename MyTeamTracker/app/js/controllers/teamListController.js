define(['controllers/controllers', 'services/dataservice', 'breeze', 'services/logger'],
    function (controllers) {
        controllers.controller('teamListController', ['$scope', 'dataservice', '$modalInstance', 'logger',
